...
public interface Creep extends Comparable<Creep>, Drawable {
  ...
  public class DamageReport {
    ...
    /**
     * Returns whether this damage was a kill directly. If the damage was increased because the
     * creep was taking extra damage due to the effect of another tower, and this caused the creep
     * to be killed, this will be false even though the tower was killed.
     */
