...
public interface Tower extends Drawable, Buildable, Cloneable {
   ...
   * @return The bullets shot by this tower after the last tick and up to this one null if the tower
   *     is to be removed
   */
   ...
   *
   * <p>Towers should only be aided by the highest increaseFactor they are currently receiving in
   * each attribute. An increaseFactor of 1 (which means no increase) signals that the aiding tower
   * has been sold.
   */
