...
public class OverlayButton extends JButton {
  ...
  public OverlayButton(
      String text, float fontSize, Color textColour, float sideMargin, float topBottomMargin) {
    ...
    textHeight =
        (float) (new TextLayout("W", font, frc).getBounds().getHeight() + topBottomMargin * 2);
    setUpButton();
    setText(text);
  }
  ...
  public static OverlayButton makeUpgradeButton(String imageName) {
    return new OverlayButton(
        ImageHelper.loadImage("buttons", "upgrades", imageName),
  ...
  public void setText(String text) {
    ...
    BufferedImage b =
        new BufferedImage(
            (int) (width + 0.5), (int) (textHeight + 0.5), BufferedImage.TYPE_INT_ARGB_PRE);
  ...
  public static ImageIcon drawOverlay(BufferedImage image, Color colour) {
    ...
    g.fillRect(
        image.getWidth() - overlayWidth,
        overlayWidth,
        overlayWidth,
        image.getHeight() - overlayWidth);
    g.fillRect(0, image.getHeight() - overlayWidth, image.getWidth() - overlayWidth, overlayWidth);
    g.dispose();
