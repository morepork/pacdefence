...
public class ControlPanel extends JPanel {
  ...
  private OverlayButton damageUpgrade,
      rangeUpgrade,
      rateUpgrade,
      speedUpgrade,
      specialUpgrade,
  ...
  public ControlPanel() {
    ...
    backgroundImage =
        ImageHelper.loadImage(width, height, "control_panel", "blue_lava_blurred.jpg");
  ...
  public void setCurrentInfoToCreep(Creep c) {
    if (c == null) {
      ...
      damageDealtLabel.setText(
          "Speed: "
              + Helper.format(c.getSpeed() * Constants.CLOCK_TICKS_PER_SECOND, 0)
              + " pixels/s ");
  ...
  public void updateLevelStats(
      String level, String numCreeps, String hp, String timeBetweenCreeps) {
  ...
  private JPanel createLeftRightPanel(
      String text, float textSize, Color textColour, MyJLabel label) {
  ...
  private JPanel createLeftRightPanel(
      Component c, float textSize, Color textColour, MyJLabel label) {
    label.setForeground(textColour);
    label.setFontSize(textSize);
  ...
  private void setUpNewTowers() {
    ...
    gl.setVgap(2);
    panel.setLayout(gl);
    assert buildables.length == total
        : "Number of tower implementations is " + "different to number of buttons.";
      ...
      b.addActionListener(
          new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              eventProcessor.processEndLevelUpgradeButtonPress(
                  o.equals(livesUpgrade),
                  o.equals(interestUpgrade),
                  o.equals(moneyUpgrade),
                  getAttributeFromButton(o));
            }
          });
      b.addChangeListener(
          new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
              OverlayButton o = (OverlayButton) e.getSource();
              eventProcessor.processEndLevelUpgradeButtonRollover(
                  o.equals(livesUpgrade),
                  o.equals(interestUpgrade),
                  o.equals(moneyUpgrade),
                  getAttributeFromButton(o),
  ...
  private void setUpCurrentTowerInfo() {
    MyJLabel[] labels =
        new MyJLabel[] {towerNameLabel, towerLevelLabel, killsLabel, damageDealtLabel};
    float textSize = defaultTextSize - 1;
  ...
  private void setUpLevelStats() {
    ...
    box.add(
        createLeftRightPanel(
            "Between Creeps", textSize, defaultTextColour, timeBetweenCreepsLabel));
